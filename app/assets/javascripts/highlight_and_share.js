+function ($) { "use strict";
  ...
  Hish.prototype.bindEvents = function() {
    ...
    $('#hish-share-twitter').click(function(e) {
      var twitter_intent_url = "https://twitter.com/intent/tweet?hashtags=OutlawChurch&text=" + _this.getText() + "&url=" + document.URL;
  ...
  Hish.prototype.getText = function() {
    ...
    var text = highlighted.length > 115 ? '' + window.getSelection().toString().substring(0, 100) + '...' : highlighted;
    text = '"' + text + '"';
    return text;
  }
