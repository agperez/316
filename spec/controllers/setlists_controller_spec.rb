...
describe SetlistsController do
  ...
  let(:valid_attributes) { { "date" => "2014-07-07" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved setlist as @setlist" do
        ...
        post :create, {:setlist => { "date" => "invalid value" }}, valid_session
        assigns(:setlist).should be_a_new(Setlist)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested setlist" do
        ...
        Setlist.any_instance.should_receive(:update).with({ "date" => "2014-07-07" })
        put :update, {:id => setlist.to_param, :setlist => { "date" => "2014-07-07" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the setlist as @setlist" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Setlist.any_instance.stub(:save).and_return(false)
        put :update, {:id => setlist.to_param, :setlist => { "date" => "invalid value" }}, valid_session
        assigns(:setlist).should eq(setlist)
      end
