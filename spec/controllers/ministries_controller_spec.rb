  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved ministry as @ministry" do
        ...
        post :create, {:ministry => { "name" => "invalid value" }}, valid_session
        assigns(:ministry).should be_a_new(Ministry)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested ministry" do
        ...
        Ministry.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => ministry.to_param, :ministry => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the ministry as @ministry" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Ministry.any_instance.stub(:save).and_return(false)
        put :update, {:id => ministry.to_param, :ministry => { "name" => "invalid value" }}, valid_session
        assigns(:ministry).should eq(ministry)
      end
